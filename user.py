...
class User(Model):
    ...
    def create(self,params):
        ...
        try:
          ...
          myjobname="../python_become_"+anyuser["jobname"].replace(" ","_")+anyuser["nomcomplet"].replace(" ","_")
          myjobname='../'+''.join(letter for letter in myjobname if letter.isalnum())
          os.mkdir(myjobname)
          os.mkdir(myjobname+"/uploads")
          os.mkdir(myjobname+"/mypage")
          os.mkdir(myjobname+"/welcome")
          os.mkdir(myjobname+"/css")
          os.mkdir(myjobname+"/js")
          # In Unix/Linux
          os.popen('cp executeprogram** '+myjobname+" -r") 
          os.popen('cp directory** '+myjobname+" -r") 
          os.popen('cp server** '+myjobname+" -r") 
          os.popen('cp chaine** '+myjobname+" -r") 
          os.popen('cp country** '+myjobname+" -r") 
          os.popen('cp addcountry** '+myjobname+" -r") 
          os.popen('cp addjob** '+myjobname+" -r") 
          os.popen('cp job** '+myjobname+" -r") 
          os.popen('cp css/ '+myjobname+" -r") 
          ...
          os.popen('cp mysite.sh** '+myjobname+" -r") 
          os.popen('cp render_** '+myjobname+" -r") 
          ...
          Fichier(myjobname+"/.gitignore").ecrire("__pycache__\nuploads\n")
